...
// This collects all the scores and stored them
    inputScore = result
    localStorage.setItem("interviewScore", result)  
    inputScore = localStorage.getItem("interviewScore")
}

// For Result page
function checkitout() {
    // This displays the score of the result
    document.getElementById("score").innerHTML = localStorage.getItem("interviewScore")

    // This Checkmates the score level for grade output
    let grade = localStorage.getItem("interviewScore")
    if(grade >= 80) {
